...
export async function storeGeneratedImage({
  ...
  try {
    ...
    // Handle different edit-image and generate-image model costs
    if (model.startsWith("edit-image") || model.startsWith("generate-image")) {
...
export function getModelType(config) {
  ...
  if (config.see_dreams_3_generate) return 'generate-image-seedream';
