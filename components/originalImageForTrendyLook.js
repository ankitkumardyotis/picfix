...
function OriginalImage({ setIsImageLoaded, setOriginalImageHieght,setOriginalImageWidth, fileUrl,setFileUrl}) {
  ...
  return (
    <div style={{ padding: '0' }}>
      <Image src={fileUrl} alt="Original Pic" style={imageStyle}
