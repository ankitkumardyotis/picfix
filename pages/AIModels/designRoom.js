...
function DesignRoom() {
    ...
    return (
        <>
            <Head>
                <title>Room Designer | PicFix.AI </title>
                <meta name="description" content=" PicFix offers professional  and enhance the quality of your cherished photographs. Get started today!" />
            ...
            >
                <Container maxWidth="xl">
                    ...
                    <Typography variant="h6" sx={{ fontWeight: "500", marginBottom: "5px", color: " #0e0e0e", textAlign: "center", }}>
                        Design your room with our Technology
                    </Typography>
                    {!restoredPhoto && !fileUrl &&
                        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: matches ? 'row' : 'column' }}>
                            <TextField onChange={handleInputChange} sx={{ minWidth: matches ? 480 : '80%', margin: '20px' }} id="clothingText" label="Describe the room Design you want to create." variant="outlined" placeholder="Ex. a cheerful modernist bedroom" />
                        </Box>
                    }
